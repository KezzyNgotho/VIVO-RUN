    ...
    try {
      ...
      try {
        ...
        if (allowedCheck.error) {
          ...
          if (errorMsg.includes('not installed') || errorMsg.includes('not found') || errorMsg.includes('Extension')) {
        ...
        // If it's a different error, continue with connection attempt
        console.warn('Warning during isAllowed check:', checkError);
      }
