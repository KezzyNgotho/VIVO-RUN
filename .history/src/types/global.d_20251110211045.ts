...
declare global {
  interface Window {
    ...
    // Legacy function names for backwards compatibility with game.js
    ...
    debugWallet: () => { connected: boolean; publicKey?: string; status: string };
    ...
    currentQuestId: number;
        ...
        walletState?: {
          ...
          getStatus: () => { connected: boolean; publicKey?: string };
        };
      }
    }
